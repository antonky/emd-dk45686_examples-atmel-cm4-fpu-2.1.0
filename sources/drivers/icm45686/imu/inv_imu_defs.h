...
#define INV_IMU_ERROR_TIMEOUT                                                  \
  -4 /**< Action did not complete in the expected time window */
#define INV_IMU_ERROR_BAD_ARG -11 /**< Invalid argument provided */
#define INV_IMU_ERROR_EDMP_ODR                                                 \
  -126 /**< EDMP ODR decimator reconfiguration is needed */
...
/*
 * STATUS_MASK_PIN_X_Y
 * Applies to STATUS_MASK_PIN_0_7_IPREG_TOP1, STATUS_MASK_PIN_8_15_IPREG_TOP1
 * and STATUS_MASK_PIN_16_23_IPREG_TOP1.
 */
