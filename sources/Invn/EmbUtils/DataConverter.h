...
/** @brief Converts an array of 32-bit signed fixed-point integers to an array
 * of floats
 *  @param[in]   in    Pointer to the first element of the array of 32-bit
 * signed fixed-point integers
 *  @param[in]   len   Length of the array
 *  @param[in]   qx    Number of bits used to represent the decimal part of the
 * fixed-point integers
 *  @param[out]  out   Pointer to the memory area where the output will be
 * stored
 */
void inv_dc_sfix32_to_float(const int32_t *in, uint32_t len, uint8_t qx,
                            float *out);

/** @brief Converts an array of floats to an array of 32-bit signed fixed-point
 * integers
 ...
 * stored
 */
void inv_dc_float_to_sfix32(const float *in, uint32_t len, uint8_t qx,
                            int32_t *out);
