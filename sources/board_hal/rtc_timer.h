 ...
 * @param  rtc_irq_handler RTC clock IRQ handler, set to NULL in case no wake up
 * is required from RTC
 */
...
/**
 * @brief  Get timestamps from RTC calendar counters in microsecond and prevent
 * rollover
