 ...
 *  @param[in] s      Pointer to device.
 *  @param[out] data  Current accel, gyro and temperature data from the
 * registers.
 *  @return           0 on success, negative value on error.
 */
 ...
 *  @param[in] s      Pointer to device.
 *  @param[out] data  Accel, gyro and temperature data from the top frame on the
 * FIFO.
 *  @return           0 on success, negative value on error.
 */
 ...
 *         Use `SMC_CONTROL_0_ACCEL_LP_CLK_WUOSC` for Ultra Low Power (ULP)
 * mode.
 *  @note In ULP mode, sensor registers are not available and the host must
